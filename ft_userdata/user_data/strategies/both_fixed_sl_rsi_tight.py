...
class both_fixed_sl_rsi_tight(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # RSI conditions (tightened: long 30-50, short 55-70)
        rsi_long_ok = (dataframe["rsi"] >= 30.0) & (dataframe["rsi"] <= 50.0)
        rsi_short_ok = (dataframe["rsi"] >= 55.0) & (dataframe["rsi"] <= 70.0)
