...
class long_htf_hold(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # HTF EMA20 Trend Filter (4H close > 4H EMA20)
        htf_long_ok = dataframe["close_4h"] > dataframe["ema20_4h"]
    ...
    def custom_exit(
        ...
        **kwargs,
        ...
        """Geen range-invalidation exit zolang SL niet geraakt is.
        Geen extra exits onder 1R. Exits verlopen uitsluitend via SL (-0.0631), ROI-ladder en trail na 1R.
        """
        return None
